...
* @see https://v0.dev/t/KzlkorEKPZU
    ...
    <div className="grid min-h-screen w-full md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr]">
      ...
      <div className="flex flex-col">
        ...
        <main className="flex flex-1 flex-col bg-gray-100 ">
          ...
          <div
            className="flex flex-1 items-center justify-center rounded-lg border border-gray-200 border-dashed shadow-sm dark:border-gray-800"
